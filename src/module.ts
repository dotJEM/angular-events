...
(function () {
    ...
    module.service('dxObservable', ['$rootScope','$q',function ($rootScope, $q) {
         ...
         * @description
         *
         * A token for a subscription to an observable. Can be used to unsubscribe from
         * the observable again.
         */
        interface ISubscription {
            /**
             * @ngdoc method
             * @name ISubscription#dispose
             * @description
             *
        ...
        function Observable() {
             ...
             */
            self.subscribe = function (callback):ISubscription {
